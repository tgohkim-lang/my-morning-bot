...
YOUTUBE_API_KEY = os.getenv('AIzaSyAhX3cc08D_U521nTDVCmk0qwksBmPRUPA')
GEMINI_API_KEY = os.getenv('AIzaSyDLcoFO8UqIiOhrhIuoLG9pEHGUeHBGQ4I')

# 2. Gemini AI 설정
genai.configure(api_key=AIzaSyDLcoFO8UqIiOhrhIuoLG9pEHGUeHBGQ4I)
